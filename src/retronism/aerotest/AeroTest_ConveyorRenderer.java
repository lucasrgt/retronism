...
public class AeroTest_ConveyorRenderer extends TileEntitySpecialRenderer {

	public static final Aero_MeshModel MODEL = Aero_ObjLoader.load("/models/Conveyor.obj");

	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTick) {
		AeroTest_ConveyorTile tile = (AeroTest_ConveyorTile) te;
		// Reuses the existing motor texture so the showcase needs no new
		// asset — the visual goal is "see the texture scroll", not "look
		// like a real conveyor". Any horizontally-tiled texture works.
