...
public class AeroTest_EasingShowcaseRenderer extends TileEntitySpecialRenderer {

	public static final Aero_MeshModel MODEL = Aero_ObjLoader.load("/models/EasingShowcase.obj");

	public void renderTileEntityAt(TileEntity te, double x, double y, double z, float partialTick) {
		AeroTest_EasingShowcaseTile tile = (AeroTest_EasingShowcaseTile) te;
		bindTextureByName("/models/aerotest_easings.png");
